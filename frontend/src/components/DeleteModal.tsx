...
const DeleteModal: FC<DeleteModalProps> = ({
  ...
  return (
    <div className="fixed bg-slate-900 bg-opacity-80 filter backdrop-blur-[1px] w-full h-full top-0 left-0">
      <div 
        className="fixed flex flex-col justify-center items-center z-10 top-20 left-1/2 translate-x-[-50%] bg-theme-neutral rounded-lg w-11/12 md:w-2/3 lg:w-1/3 h-1/2 shadow-3xl border-2 border-gray-300 p-3 animate-[slidein_0.3s_ease-in-out_forwards]">
