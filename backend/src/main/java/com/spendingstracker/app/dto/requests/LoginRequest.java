 ...
 *       will be populated.
 *   <li>If user is signing in with Google, <code>googleCredential</code> will be populated.
 * </ul>
 */
public record LoginRequest(String username, String password, String googleCredential) {}
