CREATE TABLE
    IF NOT EXISTS APP.USER (
        ...
        PASSWORD VARCHAR(64) NULL DEFAULT NULL COMMENT "User's password as an encrypted string. Nullable since external users don't have a password.",
        ...
        HAS_MFA CHAR(1) NOT NULL DEFAULT "N" COMMENT "Indicates if user has an MFA associated to their account. N is No, Y is Yes",
